...
//                   return _buildMenuItems('${restaurant[index]}' as List<Data?>, context, index);
//                 },
...
//       List<Data?> restaurant, BuildContext context, int index) {
//     return Column(
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
//         Padding(
...
//               .where((menuItem) => menuItem.category == restaurant[index])
//               .map((menuItem) => Column(
//             children: [
//               Container(
//                 color: Colors.white,
